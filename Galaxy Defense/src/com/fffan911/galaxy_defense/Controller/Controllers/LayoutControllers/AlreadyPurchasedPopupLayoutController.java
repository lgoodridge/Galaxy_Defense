...
public class AlreadyPurchasedPopupLayoutController extends Controller {
	//Constants
	private static final String TAG = "AlreadyPurchasedPopupLayoutController";
	
	//Constructor
	public AlreadyPurchasedPopupLayoutController(View view) {
		super(view);
	}
	...
	public boolean onTouchEvent(MotionEvent me) {
		if (me.getAction() == MotionEvent.ACTION_DOWN) {
			...
			shopUIProxy.closeAlreadyPurchasedPopup();
		}
		return true;
	}
}
