...
public class ControlsButtonController extends Controller {
	//Constants
	private final static String TAG = "ControlsButtonController";
	
	//Constructor
	public ControlsButtonController(View view){
		super(view);
	}
