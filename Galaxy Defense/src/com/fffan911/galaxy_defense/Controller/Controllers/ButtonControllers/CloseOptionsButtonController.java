...
public class CloseOptionsButtonController extends Controller {
	//Constants
	private final static String TAG = "CloseOptionsButtonController";
	
	//Constructor
	public CloseOptionsButtonController(View view){
		super(view);
	}
	...
	public boolean onTouchEvent(MotionEvent me) {
		if (me.getAction() == MotionEvent.ACTION_DOWN){
			...
			genericUIProxy.closeOptionsPopup();
		}
		return true;
	}
}
