...
import com.fffan911.galaxy_defense.Controller.Controllers.LayoutControllers.ShopLayoutController;

public class ShopLayout extends LinearLayout {
	//Controller
	private Controller controller;
	//Constants
	private final static String TAG = "ShopLayout";
	
	//Constructor
	public ShopLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		setController(new ShopLayoutController(this));
	}
