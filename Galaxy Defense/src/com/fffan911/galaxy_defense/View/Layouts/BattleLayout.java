...
import com.fffan911.galaxy_defense.Controller.Controllers.LayoutControllers.BattleLayoutController;

public class BattleLayout extends LinearLayout{
	//References
	private Controller controller;
	//Constants
	private final static String TAG = "BattleLayout";
	
	//Constructor
	public BattleLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		setController(new BattleLayoutController(this));
	}
