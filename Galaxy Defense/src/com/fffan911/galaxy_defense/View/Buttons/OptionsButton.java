...
import com.fffan911.galaxy_defense.Controller.Controllers.ButtonControllers.OptionsButtonController;

public class OptionsButton extends Button {
	//References
	private Controller controller;
	//Constants
	private final static String TAG = "OptionsButton";
	
	//Constructor
	public OptionsButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		setController(new OptionsButtonController(this));
		setText("Options");
	}
