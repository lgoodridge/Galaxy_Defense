...
public abstract class SpecialWeaponUpgrade extends SpecialWeapon implements Upgrade {
	//References
	private SpecialWeapon innerWeapon;
	//Constants
	private static final String TAG = "SpecialWeaponUpgrade";
	
	//Constructor
	public SpecialWeaponUpgrade(SpecialWeapon innerWeapon, Ship ownerShip) {
		super(ownerShip);
		this.innerWeapon = innerWeapon;
	}
	public SpecialWeaponUpgrade(SpecialWeapon innerWeapon) {
		this(innerWeapon, null);
	}
	public SpecialWeaponUpgrade() {
		this(null, null);
	}
	...
	public void launchSpecialAttack(Ship ship) {
		innerWeapon.launchSpecialAttack(ship);
	}
	
	//Set Methods
	public final void setInnerWeapon(SpecialWeapon weapon) {
